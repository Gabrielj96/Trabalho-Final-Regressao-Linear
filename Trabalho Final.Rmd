...
A análise de correlação mostra que todas variáveis tem certa correlação positiva com a variável dependentes e não aparenta ter problemas de multicolinearidade, já que a correlação entre variáveis indepedentes não é muito alta.
...
O modelo AIC e BIC foram bem parecidos com exceção da variáveis facebook_S que foi retirada no modelo BIC.

Considerando que a variável facebook_S tinha um valor p maior que 0.10 faz sentido dizer que o modelo Forward BIC fez a melhor seleção de variáveis.
